...
require("lazy").setup({
  ...
  -- highlight color values (names, hex, etc)
  {
...
vim.keymap.set('n', '<leader>tv', '<cmd>vnew term://bash<CR>', { noremap = true })
vim.keymap.set('n', '<leader>ts', '<cmd>split term://bash<CR>', { noremap = true })

-- Open terminal in vertical and horizontal split, inside the terminal
vim.keymap.set('t', '<leader>tv', '<c-w><cmd>vnew term://bash<CR>', { noremap = true })
vim.keymap.set('t', '<leader>ts', '<c-w><cmd>split term://bash<CR>', { noremap = true })
...
-- links in browser
vim.keymap.set("n", "gx", '<Cmd>call jobstart(["start", expand("<cfile>")], {"detach": v:true})<CR>')

-- Split window
vim.keymap.set('n', '<leader>ss', ':split<Return><C-w>j', { silent = true })
vim.keymap.set('n', '<leader>sv', ':vsplit<Return>l', { silent = true })
